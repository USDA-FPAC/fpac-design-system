  ...
  <div>
    <div class="ds-nav-rail fds-show@l">
      <ul aria-label="Primary Navigation">
        <li>
          <a href="" class="ds-nav-rail__item ds-nav-rail__item--active">
            ...
            <span class="ds-nav-rail__label">Home</span>
          </a>
        </li>
        <li>
          <a href="" class="ds-nav-rail__item">
            <span class="ds-nav-rail__icon-container">
              <span class="ds-nav-rail__background"></span>
              <svg class="fds-icon fds-icon--size-2" aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <span class="ds-nav-rail__label">Foundation</span>
          </a>
        </li>
        <li>
          <a href="" class="ds-nav-rail__item">
            ...
            <span class="ds-nav-rail__label">Components</span>
          </a>
        </li>
        <li>
          <a href="" class="ds-nav-rail__item">
            ...
            <span class="ds-nav-rail__label">Patterns</span>
          </a>
        </li>
        <li>
          <a href="" class="ds-nav-rail__item">
            ...
            <span class="ds-nav-rail__label">Utilities</span>
          </a>
        </li>
        <li>
          <a href="" class="ds-nav-rail__item">
            ...
            <span class="ds-nav-rail__label">Guides</span>
          </a>
        </li>
      </ul>
    </div>
    <div class="ds-nav-rail-drawer fds-show@l ds-nav-rail-drawer--open">
